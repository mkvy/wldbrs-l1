...
//вторым вариантом можно было бы передавать пустую структуру в worker; при закрытии структуры завершать работу функции
...
func main() {
	...
	//в бесконечном цикле ждем, когда поступит сигнал прерывания, в случае если поступил, закрываем канал
	for {
		select {
